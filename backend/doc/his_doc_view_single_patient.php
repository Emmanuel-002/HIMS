...
<body>
    ...
    <div id="wrapper">
        ...
        <?php
            ...
            {
                $mysqlDateTime = $row->date_enrolled;
            ?>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title"><?php echo $row->pat_fname;?> <?php echo $row->pat_mname;?> <?php echo $row->pat_lname;?>'s Profile</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                        ...
                        <div class="col-lg-4 col-xl-4">
                            <div class="card-box text-center">
                                ...
                                <div class="text-left mt-3">
                                    ...
                                    <p class="text-muted mb-2 font-13"><strong>Registration Number :</strong><span class="ml-2"><?php echo $row->pat_regnumber;?></span></p>
                                    <p class="text-muted mb-2 font-13"><strong>Staff/Svc No :</strong><span class="ml-2"><?php echo $row->pat_number;?></span></p>
                                    <p class="text-muted mb-2 font-13"><strong>Full Name :</strong> <span class="ml-2"><?php echo $row->pat_title;?> <?php echo $row->pat_fname;?> <?php echo $row->pat_mname;?> <?php echo $row->pat_lname;?></span></p>
                                    ...
                                    <p class="text-muted mb-2 font-13"><strong>Address :</strong> <span class="ml-2"><?php echo $row->pat_address;?></span></p>
                                    <hr>
                                    <p class="text-muted mb-2 font-13"><strong>Date Recorded :</strong> <span class="ml-2"><?php echo date("d/m/Y", strtotime($mysqlDateTime));?></span></p>
                                    <hr>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane show active" id="aboutme">
                                        <ul class="list-unstyled timeline-sm">
                                            <?php
                                                    $pres_pat_number =$_GET['pat_regnumber'];
                                    ...
                                    <div class="tab-pane show " id="timeline">
                                        <div class="table-responsive">
                                            <table class="table table-borderless mb-0">
                                                ...
                                                <?php
                                                        $vit_pat_number =$_GET['pat_regnumber'];
                                    ...
                                    <div class="tab-pane" id="settings">
                                        <ul class="list-unstyled timeline-sm">
                                            <?php
                                                    $lab_pat_number =$_GET['pat_regnumber'];
