                                ...
                                <div class="table-responsive">
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <th>Serial</th>
                                                ...
                                                <th data-toggle="true">Dependency</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="his_doc_view_single_patient.php?pat_regnumber=<?php echo $row->pat_regnumber;?>&&pat_number=<?php echo $row->pat_number;?>" class="badge badge-success"><i class="mdi mdi-eye"></i> View</a>
                                                    <a href="his_doc_update_single_patient.php?pat_regnumber=<?php echo $row->pat_regnumber;?>" class="badge badge-primary"><i class="mdi mdi-check-box-outline "></i> Update</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                        <?php  $cnt = $cnt +1 ; }?>
