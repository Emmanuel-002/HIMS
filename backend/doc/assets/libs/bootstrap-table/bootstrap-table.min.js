  ...
  (function (n) {
      ...
      r = {
        ...
        getFieldTitle: function (e, t) {
          for (
            var o = e,
              i = Array.isArray(o),
              a = 0,
              _iterator = i ? o : o[Symbol.iterator]();
            ;
          ...
          for (var y = 0; y < e.length; y++)
            for (
              var p = e[y],
                c = Array.isArray(p),
                h = 0,
                _iterator3 = c ? p : p[Symbol.iterator]();
              ;
              ...
              1 === f &&
                ((u.fieldIndex = b),
                'undefined' == typeof u.field && (u.field = b));
        ...
        getScrollBarWidth: function () {
          if (this.cachedWidth === void 0) {
            ...
            o === i && (i = t[0].clientWidth),
              t.remove(),
              (this.cachedWidth = o - i);
          }
            ...
            if (1 < h.length) {
              ...
              for (
                var l = h,
                  r = Array.isArray(l),
                  d = 0,
                  _iterator4 = r ? l : l[Symbol.iterator]();
                ;
        ...
        compareObjects: function (e, t, o) {
          ...
          for (
            var n = i,
              s = Array.isArray(n),
              l = 0,
              _iterator5 = s ? n : n[Symbol.iterator]();
            ;
        ...
        findIndex: function (e, t) {
          for (
            var o = e,
              i = Array.isArray(o),
              a = 0,
              _iterator8 = i ? o : o[Symbol.iterator]();
            ;
        ...
        o(t, [
          ...
          },
          {
            ...
            value: function () {
              var e =
                ...
                t =
                  -1 ===
                  ['bottom', 'both'].indexOf(this.options.paginationVAlign)
                    ? ''
              ...
              (this.$container = n(
                ...
                this.options.height &&
                  ...
                  -1 !==
                    this.options.classes.split(' ').indexOf('table-bordered') &&
              ...
              (this.header = {
                ...
                this.$header
                  ...
                  .on('keypress', function (o) {
                    if (
                      t.options.sortable &&
                      n(o.currentTarget).data().sortable
                    ) {
              ...
              -1 !== i &&
                ...
                void 0 !== this.options.sortClass &&
                  ...
                  (a = setTimeout(function () {
                    ...
                    var t = e.$header
                      .find('[data-field="' + e.options.sortName + '"]')
                      .index();
                    e.$el
                      .find('tr td:nth-child(' + (t + 1) + ')')
                  ...
                  : ((this.options.sortName = i.data('field')),
                    (this.options.sortOrder = this.options.rememberOrder
                      ? 'asc' === i.data('order')
                        ? 'desc'
                        : 'asc'
                      : this.columns[this.fieldsColumnsIndex[i.data('field')]]
                          .order)),
                this.trigger(
                  'sort',
            ...
            value: function () {
              ...
              this.$toolbar.find('.bs-bars').children().length &&
                ...
                'string' == typeof this.options.icons &&
                  (this.options.icons = r.calculateObjectValue(
                    null,
                    this.options.icons
                  )),
                ...
                this.options.showColumns &&
                  ...
                  this.columns.forEach(function (o, a) {
                    if (
                      !(o.radio || o.checkbox) &&
                      (!e.options.cardView || o.cardVisible)
                    ) {
                ...
                this.options.showColumns &&
                  ...
                  d <= this.options.minimumCountColumns &&
            ...
            value: function () {
              ...
              if ('server' !== this.options.sidePagination) {
                ...
                var t =
                  ...
                  o = n.isEmptyObject(this.filterColumns)
                    ? null
                    : this.filterColumns;
                (this.data = o
            ...
            value: function () {
                ...
                if (this.options.pageSize === this.options.formatAllRows())
                  ...
                  var S =
                    'string' == typeof this.options.pageList
                      ...
                      : this.options.pageList;
                  -1 !==
                    S.indexOf(this.options.formatAllRows().toLowerCase()) &&
                    (a = !0);
                }
                (this.totalPages =
              ...
              if (
                ...
                f.forEach(function (e, o) {
                  if (
                    !t.options.smartDisplay ||
                    0 === o ||
                    f[o - 1] < t.options.totalRows
                  ) {
                    var i;
                    (i = a
                  ...
                  this.options.pageNumber <
                    this.options.paginationSuccessivelySize - 1 &&
                    (d = this.options.paginationSuccessivelySize),
                  d > this.totalPages && (d = this.totalPages),
                  this.options.paginationSuccessivelySize >
                    this.totalPages - i &&
                    (i =
                      i -
                      (this.options.paginationSuccessivelySize -
                ...
                if (this.totalPages > d) {
                  var T =
                    this.totalPages - (this.options.paginationPagesBySide - 1);
                  for (
                    d >= T && (T = d + 1),
                      d + 1 === T - 1
                        ? ((s = d + 1), o.push(x(s)))
                        : T > d + 1 &&
                          (this.totalPages - d >
                            2 * this.options.paginationPagesBySide &&
                          this.options.paginationUseIntermediate
              ...
              this.$pagination.html(o.join('')),
                this.options.onlyInfoPagination ||
                  ...
                  p
                    .off('click')
                    .on('click', n.proxy(this.onPageListChange, this)),
          ...
          },
          {
            ...
            value: function (e) {
              if (
                (e.preventDefault(),
                this.options.pageNumber !== +n(e.currentTarget).text())
              )
                return (
                  (this.options.pageNumber = +n(e.currentTarget).text()),
                  this.updatePagination(e),
              ...
              if (!(-1 < r.findIndex(this.hiddenRows, e))) {
                ...
                return (
                  a.push(
                    ...
                    r.sprintf(
                      ' class="%s"',
                      s.classes || (Array.isArray(e) ? void 0 : e._class)
                    ),
                    ' data-index="' + t + '"',
                  ...
                  !this.options.cardView &&
                    ...
                    (a.push('<td>'),
                    r.calculateObjectValue(null, this.options.detailFilter, [
                      t,
                      e,
                    ]) &&
                      a.push(
                    ...
                    if (
                      ...
                      if (
                        ...
                        l.concat([o.header.styles[p]]).length &&
                          (w =
                            ' style="' +
                            l.concat([o.header.styles[p]]).join('; ') +
                            '"'),
                        e['_' + d + '_id'] &&
                          (m = r.sprintf(' id="%s"', e['_' + d + '_id'])),
                        e['_' + d + '_class'] &&
                        ...
                        w =
                          ' style="' +
                          P.concat(o.header.styles[p]).join('; ') +
                          '"';
                      }
                      if (
                      ...
                      if ($.checkbox || $.radio) {
                        ...
                        (h = [
                          ...
                          '<input\n              data-index="' +
                            ...
                            ' />',
                          o.header.formatters[p] && 'string' == typeof u
                            ? u
                            : '',
          ...
          },
          {
            ...
            value: function (e) {
              ...
              this.trigger('pre-body', o),
                ...
                this.$body.length ||
                  (this.$body = n('<tbody></tbody>').appendTo(this.$el)),
              ...
              s
                ...
                this.$body
                  ...
                  .on('click dblclick', function (e) {
                    var o = e.currentTarget,
                      ...
                      h =
                        c[
                          t.options.detailView && !t.options.cardView
                            ? p - 1
                            : p
                        ],
                    ...
                    if (
                      ...
                      (t.trigger(
                        'click' === i ? 'click-cell' : 'dbl-click-cell',
                        h,
                        u,
                        d,
                        s
                      ...
                      t.trigger(
                        'click' === i ? 'click-row' : 'dbl-click-row',
                        d,
                        l,
                        h
                      ),
                      ...
                      var f = l.find(
                        r.sprintf('[name="%s"]', t.options.selectItemName)
                      );
                      f.length && f[0].click();
                    }
                  }),
                this.$body
                  ...
                  .on('click', function (i) {
                    ...
                    if (a.next().is('tr.detail-view'))
                      ...
                      1 === d.length && d.append(p),
                        t.trigger('expand-row', s, l, d);
                    }
                ...
                this.header.events.forEach(function (e, o) {
                  ...
                  if (a) {
                    'string' == typeof a &&
                      (a = r.calculateObjectValue(null, a));
                            ...
                            t.$body
                              ...
                              .each(function (e, o) {
                                var i = n(o),
                                  d = i
                                    .find(
                                      t.options.cardView ? '.card-view' : 'td'
                                    )
                                    .eq(l),
                                  p = a.indexOf(' '),
                                  c = a.substring(0, p),
            ...
            value: function () {
              ...
              this.$header.find('th').each(function (t, o) {
                n(o)
                  ...
                  .addClass(
                    n(o).data('field') === e.options.sortName
                      ? e.options.sortOrder
                      : 'both'
                  );
              });
            ...
            value: function () {
              ...
              this.$selectAll.add(this.$selectAll_).prop('checked', e),
                this.$selectItem.each(function (e, t) {
                  n(t)
                    .closest('tr')
                    [n(t).prop('checked') ? 'addClass' : 'removeClass'](
                      'selected'
                    );
                });
            },
          },
          {
            ...
            value: function () {
              ...
              this.$selectItem.each(function (t, o) {
                e.data[n(o).data('index')][e.header.stateField] =
                  n(o).prop('checked');
              });
            },
          },
          ...
          },
          {
            ...
            value: function () {
              ...
              d.find('> *').each(function (t, o) {
                ...
                if (-1 !== a) {
                  var c = e.$header_.find(
                    r.sprintf('th[data-field="%s"]', s[a])
                  );
                ...
                for (
                  ...
                  if (l.visible) {
                    ...
                    h &&
                      ...
                      t.push(
                        r.calculateObjectValue(l, l.footerFormatter, [e], '')
                      ),
                      t.push('</div>'),
          ...
          },
          {
            ...
            value: function () {
              var e = this;
              if (this.$el.is(':hidden'))
                return void setTimeout(n.proxy(this.fitFooter, this), 100);
              var t = this.$tableBody.get(0),
                o =
                  t.scrollWidth > t.clientWidth &&
                  t.scrollHeight > t.clientHeight + this.$header.outerHeight()
            ...
            value: function (e) {
              ...
              if (
                (this.options.showHeader && this.options.height
                  ? (this.$tableHeader.show(),
                    this.resetHeader(),
                    (t += this.$header.outerHeight()))
                  : (this.$tableHeader.hide(), this.trigger('post-header')),
                this.options.showFooter &&
                  (this.resetFooter(),
                  this.options.height &&
                    (t += this.$tableFooter.outerHeight())),
                this.options.height)
              ) {
                ...
                this.$tableContainer.css('height', a + 'px'),
                  this.$tableBorder &&
                    this.$tableBorder.css('height', a - n - t - 1 + 'px');
              }
              this.getCaret(),
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              if (
                ...
                t || -1 !== i
                  ? t && -1 < i && this.hiddenRows.splice(i, 1)
          ...
          },
          {
            ...
            value: function (e) {
              ...
              'string' == typeof e &&
                'bottom' === e &&
                (t = this.$tableBody[0].scrollHeight),
          ...
          },
          {
            ...
            value: function () {
              ...
              this.options.cardView
                ? (e.removeClass(this.options.icons.toggleOff),
                  e.addClass(this.options.icons.toggleOn))
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              o.next().is('tr.detail-view') === !e &&
                o.find('> td > .detail-icon').click();
            },
          },
          {
            key: 'expandRow',
              ...
              if (e) {
                ...
                if (
                  (o.next().is('tr.detail-view')
                    ? !o.next().next().is('tr.detail-view') &&
                      (o.next().find('.detail-icon').click(), (s = !0))
            ...
            value: function (e, t) {
              this.options[r.sprintf('format%s', e)] &&
                ('string' == typeof t
                  ...
                  : 'function' == typeof t &&
                    (this.options[r.sprintf('format%s', e)] = t)),
                this.initToolbar(),
                this.initPagination(),
                this.initBody();
            },
    ...
    (n.BootstrapTable = c),
      (n.fn.bootstrapTable = function (e) {
        for (
          var t = arguments.length, o = Array(1 < t ? t - 1 : 0), i = 1;
          i < t;
          i++
        )
          o[i - 1] = arguments[i];
        ...
        return (
          this.each(function (t, i) {
            ...
            if ('string' == typeof e) {
              ...
              if (!l) return;
              (s = (d = l)[e].apply(d, o)),
                'destroy' === e && n(i).removeData('bootstrap.table');
            }
