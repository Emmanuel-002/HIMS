            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        <li>
                            <a href="his_doc_enrol_patient.php">Register Patient</a>
                        </li>
                        <li>
                            <a type="button" data-toggle="modal" data-target="#record_diagnosis">
                            Record Diagnosis
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="his_doc_manage_diagnosis.php">Manage Diagnosis</a>
                        </li>
                        <hr>
                        <li>
                            <a type="button" data-toggle="modal" data-target="#admit_patient">
                            Admit Patient
                            </a>
                        </li>
                        <li>
                            <a href="his_doc_view_admission_history.php">Admission History</a>
                        </li>
                    </ul>
                </li>
                <li>
