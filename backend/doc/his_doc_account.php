                    ...
                    <div class="row">
                        <div class="col-lg-6 col-xl-6">
                            <div class="card-box text-center">
                                <img src="../doc/assets/images/users/<?php if($row->doc_dpic!='') {echo $row->doc_dpic;} else {echo 'defaultimg.jpg';};?>" class="rounded-circle avatar-lg img-thumbnail" alt="profile-image">
